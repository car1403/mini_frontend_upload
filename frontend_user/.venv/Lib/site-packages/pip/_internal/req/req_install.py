...
class InstallRequirement:
    ...
    def supports_pyproject_editable(self) -> bool:
        ...
        with self.build_env:
            ...
            with self.pep517_subprocess_runner(runner):
                return "build_editable" in self.pep517__supported_features()
    ...
    def update_editable(self) -> None:
        ...
        vcs_obtain(self.source_dir, url=hidden_url, verbosity=0)
