...
mypage_page = st.Page("app_pages/mypage.py", title="My Page", icon="📝")
item_create_page = st.Page("app_pages/item_create_page.py", title="상품등록", icon="📝")
item_select_page = st.Page("app_pages/item_select_page.py", title="상품조회", icon="📝")
...
if st.session_state.loginout == "login":
    ...
    pages = [home_page, login_page, signup_page,weather_page, health_page]
